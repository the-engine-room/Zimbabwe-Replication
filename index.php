...
<head>
    ...
    <meta property="og:site_name" content="Transparent Mining Zimbabwe" />
    <meta property="og:title" content="Transparent Mining Zimbabwe" />

    <meta property="og:description" content="Mapping license details, connections, and trends in the allocation of Mining Licences in Zimbabwe." />
...
<body<?php if($match['name'] == 'homepage'){ echo ' class="App"'; } ?>>
        ...
        <div class="Header-inner">
            ...
            <div class="row">
                ...
                <div class="col s12 m6 offset-m3">
                    <p class="light Header-description">Mineral resources must benefit all citizens</p>
                </div>
            </div>
            ...
            <?php if($match['name'] == 'homepage'){ ?>
                <ul class="tabs Header-tabs">
                    <li class="tab col">
                        <a href="/#tab-0" class="ui-colors faded" data-view="companies">
                            <span>Browse by company</span>
                            <i class="material-icons">keyboard_arrow_right</i>
                        </a>
                    </li>
                    <li class="tab col">
                        <a href="/#tab-1" class="ui-colors faded" data-view="mines">
                            <span>Browse by mine</span>
                            <i class="material-icons">keyboard_arrow_right</i>
                        </a>
                    </li>
                    <li class="tab col">
    ...
    <?php if($match['name'] == 'about'){ ?>
        <div class="Search ui-colors green"></div>
    <?php } ?>
